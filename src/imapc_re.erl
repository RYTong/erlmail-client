...
-export([match_capability_response/1,
         ...
         match_list_response/1,
         match_status_response/1,
...
transform_list({response, Tag, "LIST", Attrs, _Delimiter, Name}) ->
  {response, Tag, "LIST", {Name, string:tokens(Attrs, "( )")}}.

transform_status({response, Tag, "STATUS", Mailbox, Items}) ->
  {response, Tag, "STATUS", {Mailbox, string:tokens(Items, "( )")}}.
